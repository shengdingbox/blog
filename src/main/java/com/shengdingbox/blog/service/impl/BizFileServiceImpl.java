...
import com.shengdingbox.blog.enums.FileUploadType;
 ...
 */
@Service
public class BizFileServiceImpl extends BizFileService {
    ...
    public int upload(MultipartFile[] file) {
        ...
        for (MultipartFile multipartFile : file) {
            FileUploader uploader = new GlobalFileUploader();
            uploader.upload(multipartFile, FileUploadType.COMMON.getPath(),configs);
        }
        return file.length;
    }
