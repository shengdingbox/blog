...
<head>
    ...
    <link href="/assets/css/npm/font-awesome.min.css" rel="stylesheet" type="text/css">
    <link href="/assets/css/npm/bootstrap.min.css" rel="stylesheet">
    <link href="/assets/css/npm/jquery-confirm.min.css" rel="stylesheet">
    <link href="/assets/css/npm/jquery.fancybox.min.css" rel="stylesheet">
    <link href="/assets/css/npm/nprogress.min.css" rel="stylesheet">
    <link href="/assets/css/npm/toastr.min.css" rel="stylesheet">
    <link href="/assets/css/npm/green.min.css" rel="stylesheet">
    <link href="/assets/css/npm/bootstrap-table.min.css" rel="stylesheet">
    <link href="/assets/css/npm/daterangepicker.min.css" rel="stylesheet">
    <link href="/assets/css/npm/bootstrap-datetimepicker.min.css" rel="stylesheet">
    <link href="/assets/css/npm/metroStyle.min.css" rel="stylesheet">
    <link href="/assets/css/npm/switchery.min.css" rel="stylesheet">
    <link href="/assets/css/npm/bootstrap-tagsinput-typeahead.min.css" rel="stylesheet">
    <link href="/assets/css/npm/bootstrap-tagsinput.min.css" rel="stylesheet">
    <link href="/assets/css/npm/index.min.css" rel="stylesheet">
<#--
    <link href="/assets/css/ajax/pnotify.css" rel="stylesheet">
    <link href="/assets/css/ajax/pnotify.buttons.css" rel="stylesheet">
    <link href="/assets/css/ajax/pnotify.nonblock.css" rel="stylesheet">-->
            ...
            <div class="left_col scroll-view">
                ...
                <div class="profile clearfix">
                    <div class="profile_pic">
                        <img src="/assets/images/index.jpg" alt="..." class="img-circle profile_img">
                    </div>
...
<#macro aboutOneBlog>
    ...
    <div class="modal-dialog modal-lg" role="document" style="width: 70%;">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel2">关于本站 - 一个简洁美观、功能强大并且自适应的Java博客</h4>
            </div>
