...
<@header title="关于 | ${config.siteName}" description="关于${config.siteName}" canonical="/about.html"></@header>
    ...
    <div class="row about-body">
        ...
        <div class="col-sm-12 blog-main">
            <div class="blog-body expansion">
                ...
                <div class="info">
                    本站为非商业化站点，无盈利性质，为博主个人博客。本站二次开发于 <a href="https://gitee.com/yadong.zhang/DBlog" title="" data-toggle="tooltip" data-placement="right" target="_blank" data-original-title="一款简洁美观、自适应的Java博客系统..."><strong>OneBlog</strong></a>。<br>
                </div>
